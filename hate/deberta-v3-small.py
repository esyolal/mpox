...
# 🔤 Tokenizer ve model
# DeBERTa-v3-small model checkpoint'ini kullanıyoruz
...
training_args = TrainingArguments(
    # Çıktı klasörünü DeBERTa-v3-small'a göre güncelledik
    output_dir="./deberta_v3_small_hate_output",
    logging_dir="./deberta_v3_small_hate_output/logs",
    eval_strategy="epoch",
...
# Kayıt yolunu DeBERTa-v3-small'a göre güncelledik
model.save_pretrained("./deberta_v3_small_hate_final_model")
tokenizer.save_pretrained("./deberta_v3_small_hate_final_model")
print("✅ Model başarıyla 'deberta_v3_small_hate_final_model' klasörüne kaydedildi (en iyi model).")
...
csv_path = "deberta_v3_small_hate_metrics_log.csv" # CSV dosya adını güncelledik
