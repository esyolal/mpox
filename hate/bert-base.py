...
# 📌 Model burada BERT Base olarak değiştirildi
...
training_args = TrainingArguments(
    output_dir="./bert_hate_output_80_20_no_weights",
    logging_dir="./bert_hate_output_80_20_no_weights/logs",
    eval_strategy="epoch",
...
model.save_pretrained("./bert_hate_final_model_80_20_no_weights")
tokenizer.save_pretrained("./bert_hate_final_model_80_20_no_weights")
print("✅ Model başarıyla 'bert_hate_final_model_80_20_no_weights' klasörüne kaydedildi (en iyi model).")
...
csv_path = "bert_hate_metrics_log_80_20_no_weights.csv"
