...
training_args = TrainingArguments(
    output_dir="./deberta_hate_output_80_20",
    logging_dir="./deberta_hate_output_80_20/logs",
    eval_strategy="epoch",
...
model.save_pretrained("./deberta_hate_final_model_80_20")
tokenizer.save_pretrained("./deberta_hate_final_model_80_20")
print("✅ Model başarıyla 'deberta_hate_final_model_80_20' klasörüne kaydedildi (en iyi model).")
...
csv_path = "deberta_hate_metrics_log_80_20.csv"
