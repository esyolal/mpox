...
training_args = TrainingArguments(
    ...
    logging_dir="./distilbert_sentiment_output/logs",
    eval_strategy="epoch",
...
# Modeli kaydet
model.save_pretrained("./distilbert_sentiment_final_model")
tokenizer.save_pretrained("./distilbert_sentiment_final_model")
print("✅ Model başarıyla 'distilbert_sentiment_final_model' klasörüne kaydedildi.")
...
csv_path = "distilbert_sentiment_metrics_log.csv"
