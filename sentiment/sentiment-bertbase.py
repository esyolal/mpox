...
training_args = TrainingArguments(
    ...
    logging_dir="./bert_sentiment_output/logs",
    eval_strategy="epoch",
...
# Modeli kaydet
model.save_pretrained("./bert_sentiment_final_model")
tokenizer.save_pretrained("./bert_sentiment_final_model")
print("✅ Model başarıyla 'bert_sentiment_final_model' klasörüne kaydedildi.")
...
csv_path = "bert_sentiment_metrics_log.csv"
