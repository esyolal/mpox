...
training_args = TrainingArguments(
    output_dir="./deberta_sentiment_output",
    logging_dir="./deberta_sentiment_output/logs",
    eval_strategy="epoch",
...
# Modeli kaydet
model.save_pretrained("./deberta_sentiment_final_model")
tokenizer.save_pretrained("./deberta_sentiment_final_model")
print("✅ Model başarıyla 'deberta_sentiment_final_model' klasörüne kaydedildi.")
...
csv_path = "deberta_sentiment_metrics_log.csv"
