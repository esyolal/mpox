...
training_args = TrainingArguments(
    output_dir="./roberta-base_stress_output",
    logging_dir="./roberta-base_stress_output/logs",
    eval_strategy="epoch",
...
model.save_pretrained("./roberta-base_stress_final_model")
tokenizer.save_pretrained("./roberta-base_stress_final_model")
...
csv_path = "roberta-base_stress_metrics_log.csv"
