...
training_args = TrainingArguments(
    output_dir="./deberta-v3-small_stress_output",
    logging_dir="./deberta-v3-small_stress_output/logs",
    eval_strategy="epoch",
...
model.save_pretrained("./deberta-v3-small_stress_final_model")
tokenizer.save_pretrained("./deberta-v3-small_stress_final_model")
print("✅ Model başarıyla tek klasör olarak 'roberta-base_stress_final_model' içine kaydedildi.")
...
csv_path = "deberta-v3-small_stress_metrics_log.csv"
