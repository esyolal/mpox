...
training_args = TrainingArguments(
    output_dir="./bert_stress_output",
    logging_dir="./bert_stress_output/logs",
    eval_strategy="epoch",
...
model.save_pretrained("./bert_stress_final_model")
tokenizer.save_pretrained("./bert_stress_final_model")
print("✅ Model başarıyla tek klasör olarak 'bert_stress_final_model' içine kaydedildi.")
...
csv_path = "bert_stress_metrics_log.csv"
